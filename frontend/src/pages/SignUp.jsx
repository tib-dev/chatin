...
import { useSignupMutation } from "../Store/Slice/authApiSlice"; // ✅ Import signup mutation
import { useDispatch } from "react-redux";
import { setAccessToken } from "../Store/Slice/authSlice"; // ✅ Store access token
...
const SignUp = () => {
  ...
  const [signup, { isLoading }] = useSignupMutation(); // ✅ Manage signup state
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      dispatch(setAccessToken(response.accessToken)); // ✅ Store token in Redux
  ...
  focus:ring-2 focus:ring-primary focus:border-primary transition-all"
            ...
            <button
              type="submit"
              className="btn btn-primary w-full focus:pointer"
              disabled={isLoading}
            >
              {isLoading ? (
                <>
